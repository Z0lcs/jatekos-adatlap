...
namespace Nyilvántartó
{
    class Program
    {
        public class EscapePressedException : Exception { }
        ...
        static string MegszakithatoBeolvasas()
        {
            string input = "";
            while (true)
            {
        ...
        static void JatekosFelvetel()
        {
            try
            {
                while (true)
                {
                    ...
                    if (!AnsiConsole.Confirm("Szeretnél újabb játékost felvenni?"))
                    {
                        break;
                    }
                }
            ...
            {
                AnsiConsole.MarkupLine("\n[yellow]Adatbevitel megszakítva, visszalépés...[/]");
                System.Threading.Thread.Sleep(1000);
            }
            Visszaleptetes();
        ...
        static void JatekosModositas()
        {
                ...
                while (true)
                {
                    ...
                    switch (mit)
                    {
                        ...
                        case "Büntetések":
                            ...
                            jatekos.Kiallitas = Szambekeres("2 perces kiállítások", 0, jatekos.Meccs * 3);
                            jatekos.PirosLap = Szambekeres("Piros lapok", 0, jatekos.Meccs);
                            break;
                    }

                    UI.SikeresMuvelet("A módosítások elmentve!");
                    if (!AnsiConsole.Confirm("Szeretnél újabb játékost módosítani?"))
                    {
                        break;
                    }
                }
            ...
            {
                AnsiConsole.MarkupLine("\n[yellow]Adatmódosítás megszakítva, visszalépés...[/]");
                System.Threading.Thread.Sleep(1000);
            }
            Visszaleptetes();
        }
        static void JatekosTorol()
        {
                ...
                while (true)
                {
                    ...
                    if (talalat != null)
                    {
                        if (AnsiConsole.Confirm($"[red]Biztosan törlöd[/] [white bold]{talalat.Nev}[/] adatait?"))
                        {
                            ...
                            UI.SikeresMuvelet("A játékos és adatai törölve!");
                            if (!AnsiConsole.Confirm("Szeretnél újabb játékost törölni?"))
                            {
                                break;
                            }
                        }
            ...
            {
                AnsiConsole.MarkupLine("\n[yellow]Adattörlés megszakítva, visszalépés...[/]");
                System.Threading.Thread.Sleep(1000);
            }
            Visszaleptetes();
        }
        static int Szambekeres(string cimke, int min, int max)
        {
            while (true)
            {
                string nyersInput = MegszakithatoBeolvasas();
                if (int.TryParse(nyersInput, out int szam) && szam >= min && szam <= max)
                {
                    return szam;
                }
                AnsiConsole.MarkupLine("[red]Érvénytelen szám! Próbáld újra.[/]");
            }
        }
        static string SzovegBekeres(string cimke, bool szamotTartalmazhat = true)
        {
            ...
            while (true)
            {
                ...
                string input = MegszakithatoBeolvasas()?.Trim();
